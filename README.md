...
This is a full-stack Next.js application built for the Reno Web Development Internship assignment.
...
I utilized AI (Antigravity) to pair-program this application. The AI assisted me in:
